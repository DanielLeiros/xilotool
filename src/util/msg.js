...
const pt = 
{
	...
	"trelicaDescricao": "As treliças são sistemas reticulados indeformáveis. Engel as classifica como elementos vetor ativos, os quais fazem a transferência de carregamentos por meio de elementos rígidos, interligados por nós, configurados na forma triangular. A eficiência das treliças depende da atuação individual de cada um desses elementos solicitados à  tração e à compressão.",
	...
	"geodescaDescricao": "São estruturas formadas por polígonos planos cuja interseção de seus vértices coincidem com uma superfície esférica ou oval. ",
}
...
const en = 
{
	...
	"geodescaDescricao": "They are structure shaped by planar polygons whose intersection of their vertices coincide with a spherical or oval surface.",
